                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ${user.id} ${user.firstName} ${user.lastName} ${user.email} <c:if
                                            test="${user.enabled > 0}">Aktywny</c:if> <c:if
                                            test="${user.enabled < 1}">Nieaktywny</c:if>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <a href="/admins/users/${user.id}"><i class="fas fa-eye fa-2x text-gray-300"></i>
                                    </a>
                                </div>
                                <div class="col-auto">
                                    <a href="/admins/users/${user.id}/edit"> <i
