    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Zarządzaj fundacjami:</h6>
                    <a class="collapse-item" href="/admins/institutions/all">Lista</a>
                    <a class="collapse-item" href="/admins/institutions">Dodaj</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Users -->
        <li class="nav-item">
            <a class="nav-link" href="/admins/users/all">
        ...
        <!-- Nav Item - Users -->
        <li class="nav-item">
            <a class="nav-link" href="/admins/donations/all">
